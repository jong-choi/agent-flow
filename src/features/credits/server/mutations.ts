...
const revalidateCreditTags = (
  ...
  revalidateTag(creditTags.allByUser(userId), "seconds");
  revalidateTag(creditTags.balanceByUser(userId), "seconds");
  revalidateTag(creditTags.summaryByUser(userId), "seconds");
  revalidateTag(creditTags.historyByUser(userId), "seconds");

  if (options?.includeAttendance) {
    revalidateTag(creditTags.attendanceByUser(userId), "seconds");
  }
};
